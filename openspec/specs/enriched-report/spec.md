...
- **THEN** Wilcoxon signed-rank test SHALL быть выполнен (через чистый numpy c нормальным приближением), результат SHALL содержать p-value
